...
import com.mbakkali.cognito.services.LoginInfo;
...
public class LoginController extends AuthenticationBase {
    ...
    public String login( @RequestParam("email") String email,
        ...
        if (Strings.isNullOrEmpty(email)) {
            ...
            redirect.addFlashAttribute("user_name_error", "Please supply a tenant");
            hasErrors = true;
        }
        else {
            userNameArg = tenant.trim() + "+" + email.trim();
            ...
            try {
                ...
                if (loginInfo != null) {
                    if (loginInfo.getNewPasswordRequired()) {
                        ...
                        UserInfo userInfo = new UserInfo(loginInfo.getUserName(), loginInfo.getEmailAddr(), loginInfo.getTenant(), password);
