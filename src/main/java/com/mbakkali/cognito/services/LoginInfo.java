...
public class LoginInfo extends UserInfo {
    ...
    public LoginInfo(final String userName, final String email, final String tenant) {
        super(userName, email, tenant);
    }
    
    public LoginInfo(final UserInfo info) {
        this(info.getUserName(), info.getEmailAddr(), info.getTenant());
    }
